...
<div>
	...
	<input type="number" id="telefono" class="cambio" name="telefono_txt" placeholder="Escribe tu teléfono" title="Tu teléfono required" value="<?php echo $registro_contacto["telefono"]; ?>" />
</div>
<div>
